  ...
  <div class="entity-form">
    ...
    <div class="form-header">
      <div class="header-left">
        ...
        <div>
          <h1 class="form-title">
            <span class="title-icon" :class="id ? 'title-icon-edit' : 'title-icon-orange'">
              <i :class="id ? 'fas fa-truck' : 'fas fa-truck-loading'"></i>
            </span>
            {{ id ? 'Editar Proveedor' : 'Nuevo Proveedor' }}
          </h1>
          <p class="form-subtitle">
            {{ id ? 'Modifica los datos del proveedor' : 'Registra un nuevo proveedor en el sistema' }}
          </p>
        </div>
      </div>
      ...
      <div class="form-single">
        ...
        <section class="form-section">
          <header class="section-header">
            ...
            <div class="section-header-content">
              ...
              <p class="section-desc">RUC o cédula del proveedor</p>
            </div>
          </header>
          <div class="section-body">
            <div class="id-row">
              <div class="form-field id-field">
                <label class="form-label" for="prov-ruc">
        ...
        <section class="form-section">
          <header class="section-header">
            ...
            <div class="section-header-content">
              ...
              <p class="section-desc">Nombre o razón social</p>
            </div>
          </header>
          <div class="section-body">
            <div class="form-row">
              <div class="form-field">
                <label class="form-label" for="prov-nombre">
                ...
                <input
                  ...
                  v-model="form.nombre"
                  placeholder="Proveedor S.A. o Juan Pérez"
                  maxlength="150"
                  :disabled="cargando"
                  @input="onNombreInput"
        ...
        <section class="form-section">
          <header class="section-header">
            ...
            <div class="section-header-content">
              ...
              <p class="section-desc">Cómo contactar al proveedor</p>
            </div>
          </header>
          <div class="section-body">
            <div class="form-row cols-2">
              <div class="form-field">
                <label class="form-label" for="prov-tel">
              ...
              <div class="form-field">
                <label class="form-label" for="prov-email">
            ...
            <div class="form-row">
              <div class="form-field">
                <label class="form-label" for="prov-dir">Dirección</label>
                <div class="input-with-icon">
        ...
        <div class="form-actions-footer">
          ...
          >
            ...
            <span>
              {{ cargando ? 'Guardando...' : (id ? 'Guardar cambios' : 'Crear proveedor') }}
            </span>
          </button>
        </div>
      </div>
...
const cargarProveedor = async () => {
  ...
  try {
    const data = await api.request(`/proveedores/${id}`, {
      method: 'GET',
      loaderMessage: 'Cargando proveedor...'
    })
    if (unmounted) return

    if (!data || !data._id) {
      errorGeneral.value = 'Proveedor no encontrado'
      return
    }
    ...
    if (codigo === 'PROVEEDOR_NOT_FOUND' || codigo === 'ID_INVALIDO') {
      errorGeneral.value = 'Proveedor no encontrado'
    } else {
...
const buscarPorIdentificacion = async () => {
  if (!puedeConsultar.value) {
    toast.warning('Solo se puede consultar con una cédula (10 dígitos) válida')
    return
  }
...
const guardar = async () => {
  ...
  try {
    ...
    if (id) {
      await api.request(`/proveedores/${id}`, {
        method: 'PUT',
      ...
      await api.request('/proveedores', {
        method: 'POST',
        body: JSON.stringify(datos),
        loaderMessage: 'Creando proveedor...'
      })
      if (unmounted) return
    ...
    if (codigo === 'PROVEEDOR_DUPLICADO' || codigo === 'DUPLICADO') {
      errores.value.ruc = 'Ya existe un proveedor con ese RUC'
      errorGeneral.value = e.message || 'Proveedor duplicado'
...
.btn-save-orange:hover:not(:disabled) { box-shadow: 0 8px 20px rgba(230,126,34,0.4); }
