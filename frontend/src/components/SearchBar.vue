...
.search-input { width: 100%; padding: 10px 40px 10px 40px; border-radius: 30px; border: 2px solid #e0e0e0; background: #fff; font-size: 0.95rem; transition: all 0.3s ease; outline: none; }
.search-input:focus { border-color: #3498db; box-shadow: 0 0 0 4px rgba(52,152,219,0.15); }
.clear-btn { position: absolute; right: 14px; cursor: pointer; color: #bdc3c7; transition: color 0.2s; }
.clear-btn:hover { color: #e74c3c; }
.search-results { position: absolute; top: calc(100% + 8px); left: 0; right: 0; background: #fff; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.12); max-height: 400px; overflow-y: auto; z-index: 1000; padding: 6px 0; }
.result-item { display: flex; align-items: center; gap: 12px; padding: 10px 16px; cursor: pointer; transition: background 0.15s; }
.result-item:hover { background: #f0f4f9; }
.result-icon { width: 36px; height: 36px; border-radius: 50%; background: #ecf0f1; display: flex; align-items: center; justify-content: center; color: #3498db; flex-shrink: 0; }
.result-content { flex: 1; min-width: 0; }
.result-title { font-weight: 500; color: #2d2d2d; font-size: 0.9rem; }
.result-subtitle { font-size: 0.8rem; color: #7f8c8d; }
.no-results { padding: 16px; text-align: center; color: #7f8c8d; font-size: 0.9rem; }
body.dark-mode .search-input { background: #1e2a4a; border-color: #2d3748; color: #e0e0e0; }
body.dark-mode .search-input:focus { border-color: #3498db; }
body.dark-mode .search-results { background: #16213e; }
body.dark-mode .result-item:hover { background: #1e2a4a; }
body.dark-mode .result-title { color: #e0e0e0; }
body.dark-mode .result-subtitle { color: #a0aec0; }
body.dark-mode .result-icon { background: #1e2a4a; }
body.dark-mode .clear-btn { color: #4a5568; }
body.dark-mode .clear-btn:hover { color: #e74c3c; }
</style>