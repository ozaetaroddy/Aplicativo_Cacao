...
.search-icon { position: absolute; left: 14px; color: var(--text-muted); font-size: 0.9rem; }
.search-input {
  width: 100%;
...
.clear-btn { position: absolute; right: 14px; cursor: pointer; color: var(--text-muted); transition: var(--transition); }
...
.result-item:hover { background: var(--bg-table-stripe); }
.result-icon {
  width: 36px;
  height: 36px;
  border-radius: 50%;
